...
INSERT INTO `acl_group` (`id`, `name`, `remark`, `createdById`) VALUES (1,'COMPANY_GROUP','Default group for master access',0),(2,'COMPANY_GROUP','Default group for master access',0),(3,'COMPANY_GROUP','Default group for master access',0);
...
INSERT INTO `acl_group_action` (`groupId`, `actionId`, `type`) VALUES (1,1,3),(1,2,3),(1,3,3),(1,4,3),(1,5,3),(1,6,3),(1,7,3),(1,8,3),(1,9,3),(1,10,3),(1,11,3),(1,12,3),(1,13,3),(1,14,3),(1,15,3),(1,16,3),(1,17,3),(1,18,3),(1,19,3),(1,20,3),(2,1,3),(2,2,3),(2,3,3),(2,4,3),(2,5,3),(2,6,3),(2,7,3),(2,8,3),(2,9,3),(2,10,3),(2,11,3),(2,12,3),(2,13,3),(2,14,3),(2,15,3),(2,16,3),(2,17,3),(2,18,3),(2,19,3),(2,20,3),(3,1,3),(3,2,3),(3,3,3),(3,4,3),(3,5,3),(3,6,3),(3,7,3),(3,8,3),(3,9,3),(3,10,3),(3,11,3),(3,12,3),(3,13,3),(3,14,3),(3,15,3),(3,16,3),(3,17,3),(3,18,3),(3,19,3),(3,20,3),(3,21,3),(3,22,3),(3,23,3),(3,24,3),(3,25,3),(3,26,3),(3,27,3),(3,28,3),(3,29,3),(3,30,3),(3,31,3),(3,32,3);
...
CREATE TABLE `asset` (
  ...
  `fileId` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `companyId` bigint(20) DEFAULT NULL,
  `createdById` bigint(20) DEFAULT NULL,
  `createdDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ext` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `user` (
  ...
  `pwd` varchar(256) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `user` (`id`, `email`, `displayName`, `imageUrl`, `pwd`, `email_active`, `personId`, `groupId`, `gsm`, `remark`, `status`, `createdDate`, `createdById`) VALUES (1,'lephuoccanh@gmail.com',NULL,NULL,'$2b$10$KuvTGT1Wv.qzDhy/Mc2EqO2YSnONjI.7V1Kqf9rGBuNTf/5e7M0jq',1,NULL,2,NULL,NULL,1,'2020-07-03 18:32:04',0),(2,'admin@gmail.com',NULL,NULL,'$2b$10$eHoDo7izZTKp8sFJ/Oabju9G70Px3vQqWsV73PLwp3IOTrO69dU12',1,NULL,3,NULL,NULL,1,NULL,0);
...
INSERT INTO `user_activate` (`id`, `user_id`, `active_code`, `date_inserted`) VALUES (1,1,'a2ce39bfdbe9eadc61e1073d5bcf5b40','2020-07-03 18:32:04'),(2,2,'819ad08b8a8c0768e42c60cd8d79cbdc','2020-08-04 03:01:23');
