...
INSERT INTO `acl_group` VALUES (1,'COMPANY_GROUP','Default group for master access',0),(2,'COMPANY_GROUP','Default group for master access',0);
...
INSERT INTO `business_action` VALUES (1,'Purchase Order'),(2,'Sale Order'),(3,'Warehouse Good Receipt'),(4,'Warehouse Good Issue'),(5,'Receipt Voucher'),(6,'Payment Voucher');
...
CREATE TABLE `cost` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(250) DEFAULT NULL,
  `type` tinyint DEFAULT NULL COMMENT 'IN: 1\nOUT: 2',
  ...
  `lastModifiedById` bigint DEFAULT NULL,
  `partnerCompanyId` bigint DEFAULT NULL,
  `partnerPersonId` bigint DEFAULT NULL,
  `remark` text,
  PRIMARY KEY (`id`),
...
CREATE TABLE `cost_purpose` (
  ...
  `relativeId` bigint NOT NULL DEFAULT '0',
...
CREATE TABLE `inventory_detail` (
  ...
  `inventoryDetailId` int NOT NULL,
...
CREATE TABLE `inventory_summary_serial` (
  `inventorySummaryId` bigint NOT NULL,
  `serialCode` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `quantity` int DEFAULT '0',
...
CREATE TABLE `order` (
  ...
  `partnerPersonId` bigint NOT NULL,
  `partnerCompanyId` bigint DEFAULT '0',
  `type` tinyint DEFAULT NULL COMMENT '1: Purchase Order\n2: Sale Order',
  `companyId` bigint NOT NULL,
...
CREATE TABLE `product` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
  `imageId` bigint DEFAULT NULL COMMENT 'Default image preview.',
...
INSERT INTO `user` VALUES (1,'lephuoccanh@gmail.com',NULL,NULL,'$2b$10$KuvTGT1Wv.qzDhy/Mc2EqO2YSnONjI.7V1Kqf9rGBuNTf/5e7M0jq',1,NULL,2,NULL,NULL,1,'2020-07-03 18:32:04',0);
...
INSERT INTO `user_activate` VALUES (1,1,'a2ce39bfdbe9eadc61e1073d5bcf5b40','2020-07-03 18:32:04');
...
-- Dump completed on 2020-07-31 11:27:04
